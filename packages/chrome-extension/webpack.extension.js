...
const files = glob.sync('./app/scripts/**/*.js', {
  dot: true,
  ignore: ['./app/scripts/chromereload.js', './app/scripts/contentscript.js'],
});
...
const allJs = {
  ...
  plugins: [
    new CopyPlugin([
      ...
      {
        from: path.resolve(__dirname, 'app/config'),
      ...
      {
        from: path.resolve(__dirname, 'app/chromereload.js'),
...
module.exports = [allJs, contentJs];
